...
export const getSafePredictedAddress = async (provider: any, nouns?: string) => {
  ...
  const safeSdkOwnerPredicted = await safeFactory.predictSafeAddress(safeAccountConfig, nouns);
